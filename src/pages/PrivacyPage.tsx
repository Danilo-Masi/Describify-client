...
export default function PrivacyPage({ isBannerVisibile, setModalWaitListOpen }: { isBannerVisibile: boolean, setModalWaitListOpen: Dispatch<SetStateAction<boolean>> }) {
