export const questions = {
    ...
    it: [
        ...
        },
        {
            ...
            content: "Un token corrisponde a una singola descrizione generata."
        },
        {
            title: "I token vengono consumati in caso di generazione fallita?",
            content: "Se la generazione della descrizione fallisce a causa di un errore di rete o della piattaforma, nessun token verrà consumato."
        },
        {
            title: "Posso cancellare il mio abbonamento?",
            content: "Puoi cancellare il tuo abbonamento in qualsiasi momento. Se hai ancora token a disposizione, rimarranno utilizzabili fino alla fine del periodo di abbonamento, senza costi aggiuntivi."
        },
        {
        ...
        },
        {
            ...
            content: "Nel riquadro della descrizione generata, troverai un pulsante con un punto interrogativo. Cliccandolo, si aprirà un modulo in cui potrai segnalarci il problema."
        },
        {
            title: "Come posso contattarvi?",
            content: "Troverai tutti i nostri canali social e l'indirizzo email aziendale nel footer in basso, dove potrai contattarci direttamente."
        }
    ]
};
