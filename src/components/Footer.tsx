            ...
            <div className="w-[90%] h-auto flex-wrap flex flex-col md:flex-row items-start justify-start gap-y-10 py-20">
                ...
                <FooterCol mdWidth='md:w-2/5' mdItemsPosition='md:items-start'>
                    ...
                    <div className='w-full flex items-center md:items-start justify-center md:justify-start gap-x-5'>
                        <a href='https://www.instagram.com/describify' target='_blank' rel='noopener noreferrer' title='link Instagram profile'>
                        ...
                        <a href='https://twitter.com/describify' target='_blank' rel='noopener noreferrer' title='link Twitter profile'>
                        ...
                        <a href='https://github.com/Danilo-Masi/Decribify' target='_blank' rel='noopener noreferrer' title='link Github project file'>
                            <svg className="w-6 h-6 text-custom-textPrimaryGray hover:text-custom-hoverGray dark:text-dark-textPrimaryGray hover:dark:text-dark-hoverGray" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <FooterCol>
                    ...
                    <a href="mailto:info@describify.it?subject=Hey!!%20👋" title='link to send email to Describify' target='_blank' rel='noopener noreferrer' className='text-center font-light text-custom-textSecondaryGray hover:text-custom-hoverColor dark:text-dark-textSecondaryGray dark:hover:text-dark-hoverColor'>info@describify.it</a>
                </FooterCol>
            </div>
        </div>
    );
