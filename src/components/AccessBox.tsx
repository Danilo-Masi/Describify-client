export default function AccessBox() {
    return (
        <div className="w-full md:w-1/2 h-auto md:h-full flex flex-col items-start justify-center gap-3 px-6 md:px-20 py-10 md:py-0 bg-custom-accent dark:bg-dark-accent">
