...
export default function Chart({ setModalOpen }: ChartProps) {
    ...
    return (
        <div className="w-full h-full bg-custom-elevation dark:bg-dark-elevation rounded-lg shadow p-4 md:p-6">

            {/* Intestazione */}
            <div className="flex justify-between pb-4 mb-4 border-b border-custom-borderGray dark:border-dark-borderGray">
                <div className="flex items-center">
                    <div className="w-12 h-12 rounded-lg bg-gray-900 dark:bg-gray-700 flex items-center justify-center me-3">
