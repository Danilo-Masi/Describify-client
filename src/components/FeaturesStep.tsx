    ...
    return (
        <div className="w-full flex flex-col md:flex-row gap-y-10 gap-x-5">
            ...
            <div className={`w-full md:w-1/2 flex flex-col items-center justify-center gap-y-5 text-center  ${order1}`}>
                <h1 className="text-4xl text-custom-textPrimaryGray dark:text-dark-textPrimaryGray text-balance font-poppins font-semibold">{data.title}</h1>
                <p className="text-lg text-custom-textSecondaryGray dark:text-dark-textSecondaryGray text-balance font-lora font-light">{data.caption}</p>
            </div>
            {/* Features img */}
