export default function Login({ onClick, onNotAccount }: { onClick: () => void, onNotAccount: () => void }) {
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Don’t have an account yet? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={onNotAccount}>Sign up</a>
                            </p>
                        </form>
                    </div>
                </div>
