...
export default function CardPrice({ titlePlan, pricePlan }: CardPriceProps) {
    return (
        <Card className='w-full md:w-1/3'>
            <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">{titlePlan}</h5>
            ...
            <button
                type="button"
                className="inline-flex w-full justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-cyan-200"
            >
                Choose plan
            </button>
        </Card>
