        ...
        <Accordion className="w-full md:w-1/2 border border-custom-borderGray dark:border-dark-borderGray">
            {domande && domande.map((domanda, index) => (
                <AccordionPanel key={index}>
                    <AccordionTitle className="text-custom-textPrimaryGray dark:text-dark-textPrimaryGray text-balance bg-custom-elevation dark:bg-dark-elevation hover:bg-custom-elevation3 dark:hover:bg-dark-elevation3 focus:ring-0 font-medium">{domanda.title}</AccordionTitle>
